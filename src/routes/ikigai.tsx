  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://zoda.sg/cdn/shop/files/pulsecollection-57.jpg?v=1753854949&width=1200",
      },
    ],
  }),
...
const PILLARS = [
  ...
  },
  {
    ...
    image:
      "https://zoda.sg/cdn/shop/files/Zoda_Community_of_Athletes.jpg?v=1758045516&width=768",
  },
];
...
const TECH_POINTS = [
  {
    ...
    desc: "Only the finest fabrics, meticulously chosen for exceptional performance, durability and sustainable sourcing.",
  },
  {
    title: "Body Mapping Technology",
    desc: "Garments engineered with advanced body mapping to enhance comfort, movement and performance.",
  },
  {
    title: "Ergonomic Patterns",
    desc: "Patterns that follow the body's contours for a natural fit and seamless functionality.",
  },
  {
    title: "Strategic Seam Placement",
    desc: "Optimised seams reduce friction and enhance flexibility, keeping you focused on every move.",
  },
  {
    title: "Reinforced Construction",
    desc: "Reinforced stitching built to endure — unmatched durability and lasting performance.",
  },
];
...
function IkigaiPage() {
  ...
  return (
    ...
    >
      ...
      <main
        className="zoda-fabrics-snap"
        aria-label="Our Ikigai"
        data-snap-track
      >
        {/* Hero */}
        <section
        ...
        >
          ...
          <div className="zoda-fabrics-hero__content">
            ...
            <h1 className="zoda-fabrics-hero__title">
              Empowering The Inner Alpha
            </h1>
            <p className="zoda-fabrics-hero__lede">
              The Absolute Alpha Standard in Activewear — performance,
              innovation and sustainability woven into every piece.
            </p>
          </div>
        </section>
        ...
        >
          <div className="zoda-fabrics-feature__media">
            <img
              src="https://zoda.sg/cdn/shop/files/Untitled-12.jpg?v=1729521329&width=1200"
              alt="ZODA — Fuel your goal"
              loading="lazy"
            />
          </div>
          <div className="zoda-ikigai-purpose__copy">
            <h2 className="zoda-fabrics-feature__title">
              Our Ikigai
            </h2>
            <p className="zoda-fabrics-feature__desc">
              ZODA® is inspired by the Ikigai of empowering the inner Alpha. We
              champion the relentless pursuit of personal excellence, the
              unwavering determination to overcome challenges, and the
              indomitable spirit that fuels true champions. ZODA® is not just a
              brand — it is a mindset.
            </p>
            <p className="zoda-fabrics-feature__desc">
              We are building The Absolute Alpha Standard in Activewear:
              performance sports clothing brought to life by deep innovation in
              fabric, game-changing construction technology and precision in
              design.
            </p>
          ...
          <div className="zoda-ikigai-purpose__cards" aria-label="Vision and mission">
            <article className="zoda-ikigai-purpose__card">
              ...
              <p className="zoda-ikigai-duo__body">
                To create activewear that redefines the athlete's experience -
                pushing the boundaries of innovation and inspiring a global
                community.
              </p>
            </article>
            ...
            <article className="zoda-ikigai-purpose__card">
              ...
              <p className="zoda-ikigai-duo__body">
                To revolutionise the activewear industry by building a global
                community of one million athletes who experience the
                transformative power of interactive activewear - fuelled by
        ...
        >
          <header className="zoda-fabrics-directory__head zoda-ikigai-duo__head">
            ...
            <h2 className="zoda-fabrics-directory__title">
              Vision & Mission
            </h2>
          </header>
        ...
        >
          <header className="zoda-fabrics-directory__head">
            ...
            <p className="zoda-ikigai-pillars__lede">
              Built for those who rise, conquer and push limits — high-performance,
              sustainable activewear fuelling a global movement of champions.
            </p>
          </header>
        ...
        >
          <div className="zoda-fabrics-feature__media">
            <img
              src="https://zoda.sg/cdn/shop/files/Technology_-_ZODA.jpg?v=1761731724&width=1200"
              alt="ZODA technology"
              loading="lazy"
            />
          </div>
          <div className="zoda-fabrics-feature__body">
            ...
            <p className="zoda-fabrics-feature__desc">
              We lead in activewear innovation, crafting high-performance
              garments with cutting-edge fabrics like regenerated nylons and
              recycled cotton — certified by GRS and BCI. Engineered for
              breathability, moisture-wicking and durability.
            </p>
            <div
            ...
            >
              {TECH_POINTS.map((t, index) => (
                ...
                >
                  <summary
                    className="zoda-fabrics-craft__trigger"
                  ...
                  <div
                    className="zoda-fabrics-craft__panel"
        ...
        >
          ...
          <div className="zoda-fabrics-feature__body">
            ...
            <p className="zoda-fabrics-feature__desc">
              Experience the pinnacle of performance and comfort with ZODA's
              AuraForm™. A technically advanced blend engineered using Zenith
              Tech™ exclusively for Sports Bras — providing precise support,
              exceptional durability and the confidence to push your limits.
            </p>
            <div className="zoda-fabrics-feature__actions">
              <Link to="/fabrics" className="zoda-fabrics-feature__shop">
                Meet the fabric
        ...
        >
          <div className="zoda-fabrics-feature__media">
            <img
              src="https://zoda.sg/cdn/shop/files/Feature_Grid_5.png?v=1748701164&width=1200"
              alt="ZODA sustainability"
              loading="lazy"
            />
          </div>
          <div className="zoda-fabrics-feature__body">
            ...
            <p className="zoda-fabrics-feature__desc">
              ZODA is dedicated to protecting our planet through responsible
              practices at every stage of production. We source eco-friendly
              materials including OCS and GOTS-certified organic cotton and
              GRS-certified recycled polyester.
            </p>
            <p className="zoda-fabrics-feature__desc">
              Our partners meet high social and environmental standards, ensuring
              safe, fair working conditions. We actively work towards waste
              reduction, water conservation and a circular economy.
            </p>
            <div className="zoda-fabrics-feature__actions">
        ...
        >
          <img
            className="zoda-ikigai-community__bg"
            src="https://zoda.sg/cdn/shop/files/pulsecollection-35.jpg?v=1753996919&width=2000"
            alt=""
            aria-hidden="true"
          />
          <div className="zoda-ikigai-community__overlay" />
          <div className="zoda-ikigai-community__content">
            <p className="zoda-fabrics-hero__kicker">Community</p>
            <h2 className="zoda-fabrics-hero__title">
              Together we achieve more.
            </h2>
            <p className="zoda-ikigai-community__lede">
              ZODA is more than a brand; it's a community of champions united by
              a passion for pushing limits. Whether you're a pro or just starting
              out, ZODA welcomes you.
            </p>
