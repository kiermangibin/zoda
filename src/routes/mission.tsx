...
const REWARD_TIERS = [
  {
    ...
    icon: initiatorTrophy,
    tone: "gold",
    summary: "Complete every Week 1 mission and bank the first full tier total.",
    rewards: ["Week 1 finisher badge", "Initiator tier status", "Progress counted toward the final run"],
  },
  {
    name: "Ascender",
    points: "410",
    ...
    icon: ascenderTrophy,
    tone: "coral",
    summary: "Finish Week 1 and Week 2 clean to reach the second cumulative total.",
    rewards: ["Week 2 finisher badge", "Ascender tier status", "Final Mission qualification path"],
  },
  {
    name: "Beast",
    points: "560",
    ...
    icon: beastTrophy,
    tone: "green",
    summary: "Complete every week and finish with the full mission point total.",
    rewards: ["Week 3 finisher badge", "Beast tier status", "Full Play & Win status"],
  },
];
